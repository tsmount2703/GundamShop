<%-- 
    Document   : update
    Created on : Mar 13, 2023, 1:18:15 PM
    Author     : Dell
--%>
...
<div class="row">
    <div class="span9">
        <div class="col">
            <form action="<c:url value="/admin/update_handler.do"/>">
                <div class="mb-3 mt-3">
                    <label for="product_id" class="form-label">Product ID:</label>
                    <input disabled type="text" class="form-control" id="product_id" placeholder="Product ID" value="${product.product_id}">
                    <input type="hidden" name="product_id" value="${product.product_id}">
                </div>
                <div class="mb-3">
                    <label for="productName" class="form-label">Product Name:</label>
                    <input type="text" class="form-control" id="productName" placeholder="Please enter product name" name="productName" value="${product.productName}">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="price" placeholder="Please enter price" name="price" value="${product.price}">
                </div>
                <div class="mb-3">
